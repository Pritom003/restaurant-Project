...
const YourLOCATION = { lat: 22.3509, lng: 91.8095 };
    ...
    const checkLocation = () => {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(
                ...
                (err) => {
                    setError("Unable to retrieve location. Please allow your location to be tracked.");
            ...
            {error ? (
                ...
                <div>
                    {isInRange ? (
                        ...
                        <p className="text-xs text-red-800"> you are out of our online delivery range  </p>
                    )}
                </div>
            )}
